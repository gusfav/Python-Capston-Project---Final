...
circle = folium.Circle(coordinate, radius=1000, color='#000000', fill=True).add_child(folium.Popup('CCAFS LC-40'))
...
site_map = folium.Map(location=nasa_coordinate, zoom_start=5)
LaunchSitesMap = folium.map.FeatureGroup()
...
site_map.add_child(LaunchSitesMap)
...
for index, record in spacex_df.iterrows():
    ...
    marker = folium.Marker([record['Lat'], record['Long']], popup=label, icon = icon).add_to(site_map)  
